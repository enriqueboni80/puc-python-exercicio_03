...
from .views import view_pessoas, view_departamentos

urlpatterns = [
    path("", view_pessoas.index, name="index"),
    ...
    path("pessoa/update", view_pessoas.update, name="pessoa.update"),
    ...
    path("departamento/update", view_departamentos.update, name="departamento.update"),
