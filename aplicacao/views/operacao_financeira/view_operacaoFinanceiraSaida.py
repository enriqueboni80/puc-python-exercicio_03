...
def edit(request, id):
    ...
    returnedObject['data_vencimento'] = returnedObject['data_vencimento'].strftime("%d/%m/%Y") if returnedObject['data_vencimento'] is not None else  None
    returnedObject['data_pagamento'] = returnedObject['data_pagamento'].strftime("%d/%m/%Y") if returnedObject['data_pagamento'] is not None else  None
